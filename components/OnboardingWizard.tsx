  ...
  const steps = [
    {
      ...
      content: "José est l'IA Universelle de la NDSA. Il ne remplace pas votre conseiller, il amplifie son expertise. José gère les diagnostics complexes de nutrition cellulaire 24h/24 pour transformer vos prospects en clients convaincus.",
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/95 backdrop-blur-xl z-[200] flex items-center justify-center p-6 animate-in fade-in duration-500">
      <div className="bg-white rounded-[4rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] w-full max-w-4xl overflow-hidden relative border-8 border-white/5">
        ...
        <button onClick={onClose} className="absolute top-10 right-10 p-4 hover:bg-slate-100 rounded-2xl transition-all text-slate-400">
          <X size={24} />
        </button>
        <div className="p-16">
          {!isFinal ? (
